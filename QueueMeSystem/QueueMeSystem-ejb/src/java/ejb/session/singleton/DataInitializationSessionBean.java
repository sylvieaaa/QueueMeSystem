    ...
    public class DataInitializationSessionBean {
        ...
        private void initializeDate() {
            try {
                ...
                CustomerEntity customerEntity = customerEntityControllerLocal.createCustomer(new CustomerEntity("Doe", "John", "98765432", "abc street", "zhuzhi94@gmail.com", "password"));
    ...
    //            creditCard.setCustomerEntity(customerEntity);
                ...
                MenuItemEntity curry = menuItemEntityControllerLocal.createMenuItem(new MenuItemEntity("Chicken Curry", "Best chicken curry!", new BigDecimal("1.50"), "curry.png"), indian);
